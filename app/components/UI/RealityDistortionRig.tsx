        ...
        <AnimatePresence mode="wait">
          {targetEntity ? (
            ...
            <motion.div
              ...
              className="p-4"
            >
              {/* [NO_SIGNAL] ターミナル枠組み維持 */}
              <div className="mb-2">
                <div className="text-[6px] text-zinc-700 uppercase tracking-[0.3em] mb-1">
                  LOCKED_TARGET
                </div>
                <div className="text-lg font-black text-zinc-700 tracking-tight leading-none animate-pulse">
                  [NO_SIGNAL]
                </div>
              </div>

              {/* ノイズ混じりの座標カウンター */}
              <div className="grid grid-cols-3 gap-2 text-[7px] font-mono mb-3">
                <div className="bg-zinc-900/50 border border-zinc-800/50 rounded px-2 py-1.5 shadow-[inset_0_2px_4px_rgba(0,0,0,0.5)]">
                  <div className="text-zinc-700 uppercase tracking-wider mb-0.5">ID</div>
                  <div className="text-zinc-600 font-mono animate-pulse">---.----</div>
                </div>
                <div className="bg-zinc-900/50 border border-zinc-800/50 rounded px-2 py-1.5 shadow-[inset_0_2px_4px_rgba(0,0,0,0.5)]">
                  <div className="text-zinc-700 uppercase tracking-wider mb-0.5">TYPE</div>
                  <div className="text-zinc-600 uppercase">UNKNOWN</div>
                </div>
                <div className="bg-zinc-900/50 border border-zinc-800/50 rounded px-2 py-1.5 shadow-[inset_0_2px_4px_rgba(0,0,0,0.5)]">
                  <div className="text-zinc-700 uppercase tracking-wider mb-0.5">CENT</div>
                  <div className="text-zinc-600 font-mono">±?.??</div>
                </div>
              </div>

              {/* 虚無監視ステータス */}
              <div className="p-3 bg-black/50 border border-zinc-800/30 rounded">
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-zinc-700 animate-pulse" />
                  <span className="text-[6px] text-zinc-600 uppercase tracking-[0.3em]">
                    SYSTEM_STATUS
                  </span>
                </div>
                ...
                <div className="text-[7px] text-zinc-700 font-mono mt-2 opacity-50">
                  {"// Awaiting celestial lock..."}
                </div>
              </div>
            </motion.div>
          )}
